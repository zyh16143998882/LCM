...
def run_net(args, config, train_writer=None, val_writer=None):
    ...
    from utils.flops import mmengine_flop_count
    input_shape = (1024, 3)
    mmengine_flop_count(base_model, input_shape=input_shape)
    ...
    for epoch in range(start_epoch, config.max_epoch + 1):
        ...
        for idx, (taxonomy_ids, model_ids, data) in enumerate(train_dataloader):
            ...
            elif 'modelnet' in args.config or 'fewshot' in args.config:
            ...
            loss, acc = base_model.module.get_loss_acc_raw(ret, label)
