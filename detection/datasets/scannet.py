...
DATASET_ROOT_DIR = "/data1/zhayaohua/data/scannet/scannet_train_detection_data"  ## Replace with path to dataset
DATASET_METADATA_DIR = "/data1/zhayaohua/data/scannet/meta_data" ## Replace with path to dataset
