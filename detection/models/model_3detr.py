...
class Model3DETR(nn.Module):
    ...
    def run_encoder(self, point_clouds):
        ...
        pre_enc_xyz, pre_enc_features, pre_enc_inds = self.pre_encoder(xyz, features)           # torch.Size([4, 2048, 3]) torch.Size([4, 256, 2048]) torch.Size([4, 2048])
    ...
    def forward(self, inputs, encoder_only=False):
        ...
        enc_features = self.encoder_to_decoder_projection(
            enc_features.permute(1, 2, 0)       # 4 256 2048
        ).permute(2, 0, 1)
