...
from utils.io_utils import save_checkpoint, resume_if_possible, load_model_from_ckpt
...
def make_args_parser():
    ...
    parser.add_argument(
        ...
        choices=["3detr","3detr_lcm", "3detr_t"],
    )
    ### Encoder
    parser.add_argument(
    ...
    parser.add_argument("--attn_k", default=1, type=int)
    ...
    parser.add_argument("--dist_url", default="tcp://localhost:1234", type=str)
...
def main(local_rank, args):
    ...
    if args.pretrain_ckpt:
        load_model_from_ckpt(args,args.pretrain_ckpt, model_no_ddp)
